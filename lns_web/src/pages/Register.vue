<template>
  <div class="register-form">
    ...
    <form class="form form-default" name="register-form" @submit.prevent="submitRegistration">
      <div class="row">
        <div class="col-md-5">
          <base-input label="Email" placeholder="example@email.com" v-model="email"></base-input>
          <p
            v-if="errors.email && errors.email[0]"
            class="text-danger"
          >{{errors.email && errors.email[0]}}</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-5">
          <base-input label="Username" placeholder="choose username" v-model="username"></base-input>
          <p
